...
class SituacionFamiliar(models.Model):
    ...
    cosumiopapa=models.CharField(max_length=50,verbose_name='Sustancia que consumio papa',null=True,blank=True)
    problemapapa=models.CharField(max_length=50,verbose_name='Problema causado a papa',null=True,blank=True)
    mama = models.SmallIntegerField(verbose_name='Mama', choices=opcionesConflicto, null=True, default=0)
    cosumiomama = models.CharField(max_length=50, verbose_name='Sustancia que consumio mama', null=True, blank=True)
    problemamama = models.CharField(max_length=50, verbose_name='Problema causado a mama', null=True, blank=True)
    hermano = models.SmallIntegerField(verbose_name='Hermano', choices=opcionesConflicto, null=True, default=0)
    cosumiohermano = models.CharField(max_length=50, verbose_name='Sustancia que consumio hermano(a)', null=True, blank=True)
    problemahermano = models.CharField(max_length=50, verbose_name='Problema causado a hermano(a)', null=True, blank=True)
    amigo = models.SmallIntegerField(verbose_name='Amigo', choices=opcionesConflicto, null=True, default=0)
    cosumioamigo = models.CharField(max_length=50, verbose_name='Sustancia que consumio amigo(a)', null=True,blank=True)
    problemaamigo = models.CharField(max_length=50, verbose_name='Problema causado a amigo(a)', null=True,blank=True)
    pareja = models.SmallIntegerField(verbose_name='Pareja', choices=opcionesConflicto, null=True, default=0)
    cosumiopareja = models.CharField(max_length=25, verbose_name='Sustancia que consumio pareja', null=True,blank=True)
    problemapareja = models.CharField(max_length=50, verbose_name='Problema causado a pareja', null=True, blank=True)
    familiar = models.SmallIntegerField(verbose_name='Familiar', choices=opcionesConflicto, null=True, default=0)
    cosumiofamiliar = models.CharField(max_length=50, verbose_name='Sustancia que consumio familiar', null=True,blank=True)
    problemafamiliar = models.CharField(max_length=50, verbose_name='Problema causado a familiar', null=True, blank=True)
...
class Cfisicas(models.Model):
    ...
    fp1a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name='Afectacion',null=True,   default=1)
    fp2 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Presion arterial (baja o alta)', null=True, default=0)
    fp2a = models.SmallIntegerField(choices=opcionesAfectado,verbose_name='Afectacion', null=True,  default=1)
    fp3 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Insuficiencia cardiaca', null=True, default=0)
    fp3a = models.SmallIntegerField(choices=opcionesAfectado,verbose_name='Afectacion', null=True,  default=1)
    fp4 =models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Infarto',null=True,default=0)
    fp4a=models.SmallIntegerField(choices=opcionesAfectado,null=True, verbose_name='Afectacion',  default=1)
    ...
    fp5a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    ...
    fp7a=models.SmallIntegerField(choices=opcionesAfectado,null=True, verbose_name='Afectacion',  default=1)
    fp8 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Diabetes', null=True, default=0)
    fp8a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',  default=1)
    fp9 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Gastritis', null=True, default=0)
    fp9a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp10 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Hepatitis', null=True, default=0)
    fp10a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp11 =models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Higado graso',null=True,default=0)
    fp11a=models.SmallIntegerField(choices=opcionesAfectado,null=True,verbose_name='Afectacion',  default=1)
    fp12=models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Ulceras', null=True, default=0)
    fp12a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp13 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Acido urico', null=True, default=0)
    fp13a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp14 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Cirrosis', null=True, default=0)
    fp14a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp15 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Pancreatitis', null=True, default=0)
    fp15a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name='Afectacion',  default=1)
    fp16 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Perdida de apetito', null=True, default=0)
    fp16a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp17 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Otro', null=True, default=0)
    fp17a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name='Afectacion',  default=1)
    fp18 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Descalcificacion', null=True, default=0)
    fp18a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp19 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Fracturas', null=True, default=0)
    fp19a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name='Afectacion',  default=1)
    fp20 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Perdida de dientes', null=True, default=0)
    fp20a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp21 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Otro', null=True, default=0)
    fp21a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name='Afectacion',  default=1)
    fp22 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Efisema pulmonar obstructiva', null=True,default=0)
    fp22a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp23 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Tos', null=True, default=0)
    fp23a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name='Afectacion',  default=1)
    fp24 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Neumonia', null=True, default=0)
    fp24a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name='Afectacion',  default=1)
    fp25 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Tuberculosis', null=True, default=0)
    fp25a = models.SmallIntegerField(choices=opcionesAfectado, null=True,verbose_name='Afectacion',   default=1)
    fp26 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Otro', null=True, default=0)
    fp26a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name='Afectacion', default=1)
    ...
    papaedad = models.SmallIntegerField(verbose_name='Edad del Padre',null=True,blank=True,default=0)
    papaescolaridad = models.CharField(verbose_name='Escolaridad del Padre',max_length=20,null=True,blank=True)
    papasededica = models.CharField(verbose_name='A que se dedica',max_length=20,null=True,blank=True)
    mama = models.BooleanField(verbose_name='Mama', null=True, blank=True, default=False)
    mamaedad = models.SmallIntegerField(verbose_name='Edad de la Madre',null=True, blank=True,default=0)
    mamaescolaridad = models.CharField(verbose_name='Escolaridad de la Madre',max_length=20, null=True, blank=True)
    mamasededica = models.CharField(verbose_name='A que se dedica',max_length=20, null=True, blank=True)
...
class Cmentales(models.Model):
    ...
    p1a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion", default=1)
    p2 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Insomnio', null=True, default=0)
    p2a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  default=1)
    ...
    p3a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion",  default=1)
    ...
    p4a=models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion",null=True,default=1)
    ...
    p5a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,   default=1)
    p6 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Problemas visuales', null=True, default=0)
    p6a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    p7=models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Dificultad para caminar',null=True,default=0)
    p7a=models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion",null=True,default=1)
    p8 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Temblor', null=True, default=0)
    p8a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    p9 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Incordinacion motora', null=True, default=0)
    p9a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    ...
    p10a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    p11 =models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Golpes',null=True,default=0)
    p11a=models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion",null=True,default=1)
    p12=models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Caidas', null=True, default=0)
    p12a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    ...
    p13a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    ...
    p14a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    p15 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Accidentes', null=True, default=0)
    p15a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    p16 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Otro', null=True, default=0)
    p16a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,   default=1)
    ...
    p17a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    ...
    p18a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,   default=1)
    p19 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Problemas de memoria', null=True, default=0)
    p19a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,   default=1)
    p20 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Problemas de toma de decisiones', null=True, default=0)
    p20a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    p21 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Otro', null=True, default=0)
    p21a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  default=1)
    p22 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Ansiedad', null=True, default=0)
    p22a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p23 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Celos', null=True, default=0)
    p23a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p24 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Culpa', null=True, default=0)
    p24a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p25 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Depresion', null=True, default=0)
    p25a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p26 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Desesperacion ', null=True, default=0)
    p26a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p27 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Ideas suicidas', null=True, default=0)
    p27a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p28 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Inseguridad', null=True, default=0)
    p28a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p29 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Intentos suicidas', null=True, default=0)
    p29a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    ...
    p31 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Cambios drasticos de estado de animo', null=True, default=0)
    p31a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p32 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Temor', null=True, default=0)
    p32a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p33 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Sentimientos de dañar a otro(a)', null=True, default=0)
    p33a = models.SmallIntegerField(choices=opcionesAfectado, verbose_name="Afectacion", null=True,  blank=True, default=1)
    p34 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Otro', null=True, default=0)
    p34a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
...
class Crelaciones(models.Model):
    ...
    rp1a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp2 = models.SmallIntegerField(verbose_name='Correrle de la casa',choices=opcionesSioNo, null=True, default=0)
    rp2a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp3 = models.SmallIntegerField(verbose_name='Divorcio',choices=opcionesSioNo, null=True, default=0)
    rp3a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp4 =models.SmallIntegerField(verbose_name='Mentiras',choices=opcionesSioNo,null=True,default=0)
    rp4a=models.SmallIntegerField(choices=opcionesAfectado,null=True, verbose_name="Afectacion",blank=True,default=1)
    rp5=models.SmallIntegerField(verbose_name='Perdida de confianza', choices=opcionesSioNo,null=True, default=0)
    rp5a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp6 = models.SmallIntegerField(verbose_name='Perdida de amistades',choices=opcionesSioNo, null=True, default=0)
    rp6a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp7=models.SmallIntegerField(verbose_name='Perdida de comunicacion',choices=opcionesSioNo,null=True,default=0)
    rp7a=models.SmallIntegerField(choices=opcionesAfectado,null=True, verbose_name="Afectacion",blank=True,default=1)
    rp8 = models.SmallIntegerField(verbose_name='Ruptura de relaciones de pareja',choices=opcionesSioNo, null=True, default=0)
    rp8a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp9 = models.SmallIntegerField(verbose_name='Separaciones',choices=opcionesSioNo, null=True, default=0)
    rp9a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp10 = models.SmallIntegerField(verbose_name='Vivir fuera de la casa',choices=opcionesSioNo, null=True, default=0)
    rp10a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp11 =models.SmallIntegerField(verbose_name='Otro',choices=opcionesSioNo,null=True,default=0)
    rp11a=models.SmallIntegerField(choices=opcionesAfectado,null=True, verbose_name="Afectacion",blank=True,default=1)
    rp12=models.SmallIntegerField(verbose_name='Agresion fisica',choices=opcionesSioNo, null=True, default=0)
    rp12a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp13 = models.SmallIntegerField(verbose_name='Riñas,peleas',choices=opcionesSioNo, null=True, default=0)
    rp13a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp14 = models.SmallIntegerField(verbose_name='Gritos',choices=opcionesSioNo, null=True, default=0)
    rp14a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp15 = models.SmallIntegerField(verbose_name='Lesiones',choices=opcionesSioNo, null=True, default=0)
    rp15a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    ...
    rp16a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp17 = models.SmallIntegerField(verbose_name='Insultos',choices=opcionesSioNo, null=True, default=0)
    rp17a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp18 = models.SmallIntegerField(verbose_name='Romper objetos',choices=opcionesSioNo, null=True, default=0)
    rp18a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp19 = models.SmallIntegerField(verbose_name='Otro',choices=opcionesSioNo, null=True, default=0)
    rp19a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp20 = models.SmallIntegerField(verbose_name='Demanda por robo',choices=opcionesSioNo, null=True, default=0)
    rp20a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp21 = models.SmallIntegerField(verbose_name='Homicidio',choices=opcionesSioNo, null=True, default=0)
    rp21a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp22 = models.SmallIntegerField(verbose_name='Intento de homicidio', choices=opcionesSioNo,null=True, default=0)
    rp22a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp23 = models.SmallIntegerField(verbose_name='Detenciones',choices=opcionesSioNo, null=True, default=0)
    rp23a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp24 = models.SmallIntegerField(verbose_name='Encarcelamiento', choices=opcionesSioNo,null=True, default=0)
    rp24a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp25 = models.SmallIntegerField(verbose_name='Fecha,duracion y causas',choices=opcionesSioNo, null=True, default=0)
    rp25a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp26 = models.SmallIntegerField(verbose_name='Manejo de armas',choices=opcionesSioNo, null=True, default=0)
    rp26a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp27 = models.SmallIntegerField(verbose_name='Robo',choices=opcionesSioNo, null=True, default=0)
    rp27a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    ...
    rp28a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp29 = models.SmallIntegerField(verbose_name='Otro ',choices=opcionesSioNo, null=True, default=0)
    rp29a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp30 = models.SmallIntegerField(verbose_name='Deudas',choices=opcionesSioNo, null=True, default=0)
    rp30a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp31 = models.SmallIntegerField(verbose_name='Gasto excesivo',choices=opcionesSioNo, null=True, default=0)
    rp31a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp32 = models.SmallIntegerField(verbose_name='Empeñar',choices=opcionesSioNo, null=True, default=0)
    rp32a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp33 = models.SmallIntegerField(verbose_name='Pedir prestado',choices=opcionesSioNo, null=True, default=0)
    rp33a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp34 = models.SmallIntegerField(verbose_name='Otro',choices=opcionesSioNo, null=True, default=0)
    rp34a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp35 = models.SmallIntegerField(verbose_name='Accidentes laborales',choices=opcionesSioNo, null=True, default=0)
    rp35a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp36 = models.SmallIntegerField(verbose_name='Ausentismos',choices=opcionesSioNo, null=True, default=0)
    rp36a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp37 = models.SmallIntegerField(verbose_name='Cambio de puesto',choices=opcionesSioNo, null=True, default=0)
    rp37a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp38 = models.SmallIntegerField(verbose_name='Despido',choices=opcionesSioNo, null=True, default=0)
    rp38a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp39 = models.SmallIntegerField(verbose_name='Desempleo',choices=opcionesSioNo, null=True, default=0)
    rp39a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp40 = models.SmallIntegerField(verbose_name='Problemas con compañeros/as',choices=opcionesSioNo, null=True, default=0)
    rp40a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp41 = models.SmallIntegerField(verbose_name='Problemas con superiores',choices=opcionesSioNo, null=True, default=0)
    rp41a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp42 = models.SmallIntegerField(verbose_name='Retardos',choices=opcionesSioNo, null=True, default=0)
    rp42a = models.SmallIntegerField(choices=opcionesAfectado, null=True, verbose_name="Afectacion",  blank=True, default=1)
    rp43 = models.SmallIntegerField(verbose_name='Suspension laboral', choices=opcionesSioNo,null=True, default=0)
    rp43a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp44 = models.SmallIntegerField(verbose_name='Suspension de pago',choices=opcionesSioNo, null=True, default=0)
    rp44a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp45 = models.SmallIntegerField(verbose_name='Otro',choices=opcionesSioNo, null=True, default=0)
    rp45a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp46 = models.SmallIntegerField(verbose_name='Expulsiones',choices=opcionesSioNo, null=True, default=0)
    rp46a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp47 = models.SmallIntegerField(verbose_name='Inasistencias',choices=opcionesSioNo, null=True, default=0)
    rp47a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp48 = models.SmallIntegerField(verbose_name='Reprobar año',choices=opcionesSioNo, null=True, default=0)
    rp48a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp49 = models.SmallIntegerField(verbose_name='Reprobar materia',choices=opcionesSioNo, null=True, default=0)
    rp49a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp50 = models.SmallIntegerField(verbose_name='Retardos', choices=opcionesSioNo,null=True, default=0)
    rp50a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
    rp51 = models.SmallIntegerField(verbose_name='Otro',choices=opcionesSioNo, null=True, default=0)
    rp51a = models.SmallIntegerField(choices=opcionesAfectado, null=True,  verbose_name="Afectacion", blank=True, default=1)
...
class Tratamientos(models.Model):
    ...
    consejero = models.SmallIntegerField(verbose_name='Consejero', null=True, blank=True)
    nombreconsejero = models.CharField(max_length=30, verbose_name='Nombre del consejero', null=True, blank=True)
    recibio = models.SmallIntegerField(verbose_name='Recibio tratamiento',choices=opcionesSioNo,null=True, default=0)
    endonde1 = models.SmallIntegerField(verbose_name='Centro de desintoxicacion',choices=opcionesSioNo,null=True, default=0)
    a1 = models.SmallIntegerField(verbose_name='Alcohol',choices=opcionesSioNo,null=True, default=0)
    d1 = models.SmallIntegerField(choices=opcionesSioNo, verbose_name="Drogas",null=True, default=0)
    c1 = models.SmallIntegerField(choices=opcionesSioNo, verbose_name="Concluyo",null=True, default=0)
    h1 = models.CharField(max_length=15, verbose_name="Hace cuanto tiempo",null=True,blank=True)
    r1 = models.CharField(max_length=15, verbose_name="Motivo en caso de que no",null=True,blank=True)
    endonde2 = models.SmallIntegerField(verbose_name='Tratamiento de consulta, ayuda mutua,mixto, profesional ',choices=opcionesSioNo,null=True, default=0)
    a2 = models.SmallIntegerField(verbose_name='Alcohol',choices=opcionesSioNo,null=True, default=0)
    d2 = models.SmallIntegerField(choices=opcionesSioNo, verbose_name="Drogas",null=True, default=0)
    c2 = models.SmallIntegerField(choices=opcionesSioNo, verbose_name="Concluyo",null=True, default=0)
    h2 = models.CharField(verbose_name="Hace cuanto tiempo",max_length=15,null=True,blank=True)
    r2 = models.CharField(verbose_name="Motivo en caso de que no",max_length=15,null=True,blank=True)
    endonde3 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Alternativo o religioso ',null=True, default=0)
    a3 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Alcohol',null=True, default=0)
    d3 = models.SmallIntegerField(verbose_name="Drogas",choices=opcionesSioNo,null=True, default=0)
    c3 = models.SmallIntegerField(verbose_name="Concluyo",choices=opcionesSioNo,null=True, default=0)
    h3 = models.CharField(verbose_name="Hace cuanto tiempo",max_length=15,null=True,blank=True)
    r3 = models.CharField(verbose_name="Motivo en caso de que no",max_length=15,null=True,blank=True)
    endonde4 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Tratamiento de internamiento (ayuda mutua,mixto,profesional,alternativos o religioso)',null=True, default=0)
    a4 = models.SmallIntegerField(choices=opcionesSioNo,verbose_name='Alcohol',null=True, default=0)
    d4 = models.SmallIntegerField(verbose_name="Drogas",choices=opcionesSioNo,null=True, default=0)
    c4 = models.SmallIntegerField(verbose_name="Concluyo",choices=opcionesSioNo,null=True, default=0)
    h4 = models.CharField(verbose_name="Hace cuanto tiempo",max_length=15,null=True,blank=True)
    r4 = models.CharField(verbose_name="Motivo en caso de que no",max_length=15,null=True,blank=True)
    endonde5 = models.SmallIntegerField(verbose_name='Tratamiento medico',choices=opcionesSioNo,null=True, default=0)
    a5 = models.SmallIntegerField(verbose_name='Alcohol',choices=opcionesSioNo,null=True, default=0)
    d5 = models.SmallIntegerField(verbose_name="Drogas",choices=opcionesSioNo,null=True, default=0)
    c5 = models.SmallIntegerField(verbose_name="Concluyo",choices=opcionesSioNo,null=True, default=0)
    h5 = models.CharField(verbose_name="Hace cuanto tiempo",max_length=15,null=True,blank=True)
    r5 = models.CharField(verbose_name="Motivo en caso de que no",max_length=15,null=True,blank=True)
    endonde6 = models.SmallIntegerField(verbose_name='Tratamiento psiquiatrico ',choices=opcionesSioNo,null=True, default=0)
    a6 = models.SmallIntegerField(verbose_name='Alcohol',choices=opcionesSioNo,null=True, default=0)
    d6 = models.SmallIntegerField(verbose_name="Drogas",choices=opcionesSioNo,null=True, default=0)
    c6 = models.SmallIntegerField(verbose_name="Concluyo",choices=opcionesSioNo,null=True, default=0)
    h6 = models.CharField(verbose_name="Hace cuanto tiempo",max_length=15,null=True,blank=True)
    r6 = models.CharField(verbose_name="Motivo en caso de que no",max_length=15,null=True,blank=True)
    endonde7 = models.SmallIntegerField(verbose_name='Tratamiento psicologico ',choices=opcionesSioNo,null=True, default=0)
    a7 = models.SmallIntegerField(verbose_name='Alcohol',choices=opcionesSioNo,null=True, default=0)
    d7 = models.SmallIntegerField(verbose_name="Drogas",choices=opcionesSioNo,null=True, default=0)
    c7 = models.SmallIntegerField(verbose_name="Concluyo",choices=opcionesSioNo,null=True, default=0)
    h7 = models.CharField(verbose_name="Hace cuanto tiempo",max_length=15,null=True,blank=True)
    r7 = models.CharField(verbose_name="Motivo en caso de que no",max_length=15,null=True,blank=True)
    endonde8 = models.SmallIntegerField(verbose_name='Otro ',choices=opcionesSioNo,null=True, default=0)
    a8 = models.SmallIntegerField(verbose_name='Alcohol ',choices=opcionesSioNo,null=True, default=0)
    d8 = models.SmallIntegerField(verbose_name="Drogas",choices=opcionesSioNo,null=True, default=0)
    c8 = models.SmallIntegerField(verbose_name="Concluyo",choices=opcionesSioNo,null=True, default=0)
    h8 = models.CharField(verbose_name="Hace cuanto tiempo",max_length=15,null=True,blank=True)
    r8 = models.CharField(verbose_name="Motivo en caso de que no",max_length=15,null=True,blank=True)
...
class Clinicas(models.Model):
    ...
    STATUS_CHOICES = [
        ...
        ('VENCIDA', 'Vencida'),
        ('GRACIA', 'En período de gracia'),
    ]

    clinica = models.CharField(
        max_length=30,
        unique=True,
        verbose_name='ID Clínica'
    )
    ...
    numeroDeInternos = models.SmallIntegerField(
        default=0,
        verbose_name='Número de internos'
    )
    ...
    cuanto_paga = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        default=0.00,
        verbose_name='Cuánto paga'
    )
    ...
    def vencida(self):
        ...
        dias_transcurridos = (
            timezone.now().date() - self.fecha_ultimo_pago
        ).days

        return dias_transcurridos > self.dias_gracia
